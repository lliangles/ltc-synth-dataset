...
此文件用於記錄所有引用、使用 `ltc-synth-dataset` 的專案、課程、比賽、論文。
歡迎透過 Pull Request 或 Issue 補充。
...
@misc{lliangles2026ltcsynth,
  ...
  year         = {2026},
  publisher    = {GitHub},
  howpublished = {\url{https://github.com/lliangles/ltc-synth-dataset}}
}
```
...
### YYYY-MM
- **[專案 / 課程 / 比賽名稱]**
  - 用途:(如:排班演算法測試資料 / 資料視覺化練習 / 履歷作品集)
  - 使用範圍:(如:僅 service_logs.csv / 全資料集 + generate.py)
  - 連結(選填):
-->

_(尚無紀錄——第一筆將由作者於使用時新增)_
